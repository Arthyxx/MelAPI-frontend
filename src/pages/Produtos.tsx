  ...
  if (carregando) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center min-h-screen">
        ...
        <p className="text-amber-700 dark:text-amber-400 text-xl font-medium mt-4">
          Carregando produtos...
        </p>
      </div>
    );
    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            {role === 'ADMIN' && (
              <Link
                to="/admin/produtos"
                className="bg-amber-700 hover:bg-amber-800 px-3 py-1 rounded-full text-sm transition"
              >
                Admin
              </Link>
            )}
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-amber-700 via-yellow-600 to-amber-700 animate-gradient-shift py-20 md:py-28">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h2 className="text-4xl md:text-6xl font-extrabold text-white drop-shadow-md animate-fade-in-up">
            Doçura que vem da natureza
          </h2>
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 line-clamp-2">
                    {produto.description ||
                      'Produto natural de abelhas, rico em nutrientes e sabor incomparável.'}
                  </p>
      ...
      <footer className="bg-amber-900 dark:bg-amber-950 text-amber-100 py-6 mt-8">
        <div className="container mx-auto px-4 text-center text-sm">
          <p>
            © {new Date().getFullYear()} Apiário Vitória Seven – Sabor que aquece o coração
          </p>
          <p className="mt-1 opacity-75">
            🌿 Mel puro – direto do apiário para sua mesa
          </p>
        </div>
      </footer>
    </div>
